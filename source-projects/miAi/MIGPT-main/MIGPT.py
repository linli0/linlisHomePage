...
from Local import LocalChatBot

LATEST_ASK_API = "https://userprofile.mina.mi.com/device_profile/v2/conversation?source=dialogu&hardware={hardware}&timestamp={timestamp}&limit=2"
COOKIE_TEMPLATE = "deviceId={device_id}; serviceToken={service_token}; userId={user_id}"

HARDWARE_COMMAND_DICT = {
    # 小爱音箱的型号，可以在cmd通过 micli mina 查询
    "LX06": "5-1",  # 小爱音箱Pro（黑色）
    "L05B": "5-3",  # 小爱音箱Play
    "S12A": "5-1",  # 小爱音箱
    "LX01": "5-1",  # 小爱音箱mini
...
# 通过micli list查询
MI_USER = "2515448082"  # 小米账号（手机号）
MI_PASS = "031wuxiaoci"  # 小米账号密码
OPENAI_API_KEY = "No need"  # openai的api key
SOUND_TYPE = "LX06"  # 音箱型号
AI_MODEL = "LOCAL" # LOCAL是本地ollama部署的，Online是在线
...
class MiGPT:
    ...
    async def init_all_data(self, session):
        ...
        self._init_cookie()
        if AI_MODEL == "LOCAL":
            await self._init_loacal_data_and_chatbot()
        else:
